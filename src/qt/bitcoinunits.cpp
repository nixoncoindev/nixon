...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NIXON");
    case mBTC: return QString("mNIXON");
    case uBTC: return QString::fromUtf8("μNIXON");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NixonCoins"));
    case mBTC: return QString(QObject::tr("Milli-NixonCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NixonCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
