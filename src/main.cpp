...
unsigned int nStakeMinAge = 3 * 24 * nOneHour; //  days as zero time weight
unsigned int nStakeMaxAge = 30 * 24 * nOneHour; //  days as full weight
unsigned int nStakeTargetSpacing = 2.5 * 60; // 2.5-minute stakes spacing
int64_t nTargetSpacing = 2.5 * 60;  // Same as the above
...
const string strMessageMagic = "NixonCoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 15 * CENT;
...
static const int64_t nTargetTimespan = 2.5 * 15 * 60;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("NixonCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NixonCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // NixonCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NixonCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "NIXON Genesis";
        CTransaction txNew;
        ...
        block.nNonce   = 1709512; // !fTestNet ? 1575379 : 46534;
