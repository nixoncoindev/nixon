...
static const uint256 hashGenesisBlock("0x00000570e32517fcf403c929d5c6756d41b19b83ac1cfa96f335102735081b48");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((2.5 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at NixonCoin block #0
        ...
        // Before NixonCoin block #0 - get from pregenerated table
